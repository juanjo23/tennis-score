...
class Game:
    ...
    >>> game.scores(1).scores(1).scores(2).scores(2).scores(1).scoreboard()
    [40, 30]
    >>> game.scores(2).scores(1).scores(2).scores(2).scores(2).scoreboard()
    [Evert wins]
    """
    ...
    def scores(self, player):
        if(player == 1):
            self.a = 15 if self.a == 0 else (
                30 if self.a == 15 else (40 if self.a == 30 else self.a + 1))
        else:
            self.b = 15 if self.b == 0 else (
                30 if self.b == 15 else (40 if self.b == 30 else self.b + 1))
        return self
